            ...
            <div className="w-full">
              <div className="items-stretch justify-between flex">
                <div className="w-full px-14 py-12">
                  <h2 className="mb-6 text-3xl font-bold text-dark sm:text-4xl sm:leading-snug 2xl:text-[40px] tracking-tight primary_text " data-content="website-headlines">Traditional Interior<span className="text-teal-900"> Design and Development</span></h2>
                  <p className="mb-9 text-base leading-relaxed text-gray-600 font-normal  " data-content="about-us">
                    Traditional style of interior design is characterized by a classic, elegant, and timeless aesthetic that is inspired by the design of the past. This style is all about creating a space that is both beautiful and practical, with a focus on traditional materials, colors, and patterns.

                    One of the key elements of traditional interior design is the use of rich, warm colors such as red, gold, and green. These colors are often used in combination with traditional patterns such as plaids, florals, and stripes. The use of rich colors and patterns gives a traditional interior a sense of elegance and timelessness.
                    ...
                    Overall, traditional interior design is all about creating a space that is both beautiful and practical, with a focus on traditional materials, colors, and patterns. By using rich colors, natural materials, and a mix of vintage and modern pieces, traditional design creates a space that is both elegant and timeless.
