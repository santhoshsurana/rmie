...
const Bohemian = () => {
  return (
    <section className="max-w-6xl mx-auto">
      <h2 className="mb-6 text-3xl p-5 font-bold ">Bohemian Interior<span className="text-teal-900"> Design and Development</span></h2>
      ...
      <div className="flex flex-col md:flex-row h-96 bg-teal-900">
        <div className=" md:w-2/3  font-normal  bg-gray-50">
          <p className=" text-base leading-relaxed text-justify text-gray-600 p-4 md:w-4/5" >The bohemian style also encourages a sense of comfort and relaxation, and spaces are often designed to be cozy and inviting. This can be achieved by incorporating comfortable seating, soft lighting, and warm colors and textures. In conclusion, bohemian style of interior design is a unique, colorful, and eclectic way of decorating your home. It's all about creating a space that reflects your personal style, interests, and culture. It's a style that encourages individuality and self-expression and brings a unique energy to any space. If you're looking to create a space that is both visually striking and personal, bohemian design might be the perfect style for you.</p>
        </div>
