...
const Traditional = () => {
  return (
      <section className="max-w-6xl mx-auto">
        <h2 className="mb-6 text-3xl p-5 font-bold ">Traditional Interior<span className="text-teal-900"> Design and Development</span></h2>
        ...
        <div className="flex flex-col md:flex-row h-96 bg-teal-900">
          <div className=" md:w-2/3  font-normal  bg-gray-50">
            <p className=" text-base leading-relaxed text-justify text-gray-600 p-4 md:w-4/5" >Overall, traditional interior design is all about creating a space that is both beautiful and practical, with a focus on traditional materials, colors, and patterns. By using rich colors, natural materials, and a mix of vintage and modern pieces, traditional design creates a space that is both elegant and timeless.
