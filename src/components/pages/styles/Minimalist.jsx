  ...
  return (
    <section>
      ...
      <p className="mb-9 text-base leading-relaxed text-gray-600 font-normal " data-content="about-us">Minimalist interior design is characterized by a clean, simple, and uncluttered aesthetic. This style is all about creating a space that is functional, efficient and visually pleasing. Minimalism is a design philosophy that focuses on the essentials, getting rid of the unnecessary and keeping only what is needed.
        ...
        It's a design philosophy that encourages to focus on the essentials and that less is more. Minimalist interior design is a great way to create a peaceful and serene environment and it's also a great way to reduce clutter and simplify your life. It's a design style that is timeless and elegant, and it's perfect for anyone who wants to create a simple, uncluttered, and visually pleasing space.</p>
        </div>
        </div>
    </section>
  )
