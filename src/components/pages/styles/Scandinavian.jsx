...
const Scandinavian = () => {
  return (
    <section>
      <h2 className="mb-6 text-3xl font-bold">Scandinavian Interior<span className="text-teal-900"> Design and Development</span></h2>
      <p className="mb-9 text-base leading-relaxed text-gray-600 font-normal  " data-content="about-us">

        Scandinavian style of interior design is characterized by a clean, simple, and minimalistic aesthetic that is inspired by the design movement of the Nordic countries (Denmark, Sweden, Norway, Finland, and Iceland). This style is all about creating a space that is visually pleasing, with a focus on clean lines, natural materials, and a sense of warmth.

        One of the key elements of Scandinavian interior design is the use of natural materials such as wood, stone, and metal. These materials add a sense of warmth and texture to the space and are often used in a variety of ways, from floors and walls to furniture and decor. The use of natural materials also gives a Scandinavian interior an organic and earthy feel.
