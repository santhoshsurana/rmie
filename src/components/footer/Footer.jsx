      ...
      <div className='container p-8 mx-auto'>
        <div className='flex flex-wrap md:text-left text-center text-gray-600 order-first'>
          <div className='lg:w-1/3 md:w-1/2 w-full px-4 text-sm '>
            ...
            <p><a className='py-2 pl-4' href='mailto:info@rminteriorsera.com'><FontAwesomeIcon icon={faEnvelope} className='px-2 text-teal-900' size='lg' /> info@rminteriorsera.com</a></p>
            <p className='py-2 pl-4'>
